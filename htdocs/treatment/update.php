...
if(isset($_POST['price'])){
    ...
    header("location: ../admin/AdminModification.php?message= The price was changed");
}

elseif(isset($_POST['photo'])){
    $ImageManager->updatePhotoLink($_POST['idPhoto'], $_POST['photo']);
    uploadImage();
    header("location:../admin/AdminModification.php?message= The photo was changed");
}

elseif(isset($_POST['link'])){
    $OperatorManager->updateOperatorLink($_POST['idOperator'], $_POST['link']);
    header("location:../admin/AdminModification.php?message= The link was changed");
}
elseif(isset($_POST['premium'])){
    $OperatorManager->updateOperatorToPremium($_POST['idOperator'], $_POST['premium']=='true'? 1:0);
    header("location: ../admin/AdminModification.php?message= The premium category was changed");
}
